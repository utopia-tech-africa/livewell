...
export const SeatReservation = () => {
  return (
    <ComponentLayout>
      <div className="relative flex flex-col items-center justify-center rounded-[12px] bg-[#006A7B] overflow-hidden px-6 py-20 text-center text-white">
        {/* <Image
          src={BluePattern}
        ...
        <div className="relative z-10 max-w-3xl flex flex-col items-center gap-6">
          <h2 className="text-[32px] italic font-satoshi font-extrabold leading-snug text-neutral-100">
